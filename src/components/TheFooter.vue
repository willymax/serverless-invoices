<template>
  <footer class="row text-secondary px-0 mt-3 d-print-none">
    ...
    <div class="col-md-8 text-left text-md-right">
      <small v-b-tooltip.hover :title="$t('title')" class="pointer">
      ...
      <small class="pl-2">
        ...
        {{ $t("by") }}
        <a href="https://mokuapp.io/" class="text-secondary" target="_blank">NalgiTech</a>.
      </small>
      <a
        href="https://github.com/mokuappio/serverless-invoices"
      ...
      >
        <img
          ...
          v-if="theme === 'dark'"
        />
        <img src="@/assets/img/github-dark.png" alt="Serverless Invoices Github" v-else />
      </a>
      <a href="https://app.mokuapp.io/" class="btn btn-sm btn-primary ml-2" target="_blank">{{
        $t("upgrade")
      }}</a>
    </div>
  </footer>
